...
Move EngineV1::getBestMove(ChessGame& game, int depth) {
...
void EngineV1::fastOrderMoves(vector<Move>& moves) {
...
double EngineV1::alphabeta(ChessGame& game, int depth, double alpha, double beta, bool isMaximizing) {
